...
public:
    ODriveInitializer() : Node("odrive_initializer") {
        ...
        this->declare_parameter<std::string>("control_mode_node_0", "torque");
        this->declare_parameter<std::string>("control_mode_node_1", "torque");
...
//         this->declare_parameter<std::string>("control_mode_node_0", "torque"); // Mặc định torque cho node 0
//         this->declare_parameter<std::string>("control_mode_node_1", "torque"); // Mặc định velocity cho node 1
